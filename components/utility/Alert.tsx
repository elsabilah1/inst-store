...
const Alert: React.FC<IAlert> = ({ error, success }) => {
  ...
  return (
    <div className="absolute left-1/2 top-24 z-50 w-full max-w-xs -translate-x-1/2 rounded-md bg-white text-center text-sm font-bold shadow-sm transition-all">
