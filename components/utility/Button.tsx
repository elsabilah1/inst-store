...
const Button: React.FC<IButton> = ({
  ...
  const classes = cn(
    ...
    variant === 'secondary' &&
      'bg-secondary text-primary/70 border border-secondary hover:bg-primary hover:border-white hover:text-white disabled:animate-pulse disabled:bg-secondary',
